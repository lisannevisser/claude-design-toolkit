...
1. **`.claude/_audit-standards.md`** — der **verbindliche Audit-Standard** (4 Lenses, Severity-Skala,
   Befund-Format, Report-Struktur). **Wende ihn an.**
...
## Output — `AUDIT.md` nach `_audit-standards.md`
...
Befund"-Tabelle am Ende**. Belegt vs. angenommen trennen; fehlt Evidenz → als **Lücke** benennen,
nichts erfinden.
